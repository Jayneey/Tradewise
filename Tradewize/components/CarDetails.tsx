        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
            ...
            <div className='fixed inset-0 overflow-y-auto'>
                <div className='flex min-h-full items-center justify-center p-4 text-center'>
                    ...
                    >
                        <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto no-scrollbar p-6
                        ...
                        ">
                            ...
                            <div className='flex gap-3'>
                                <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                    <Image src={generateCarImageUrl(car, '29')} alt='DemoCar' fill priority className="object-contain" />
                                </div>

                                <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                    <Image src={generateCarImageUrl(car, '33')} alt='DemoCar' fill priority className="object-contain" />
                                </div>

                                <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                    <Image src={generateCarImageUrl(car, '13')} alt='DemoCar' fill priority className="object-contain" />
                                </div>
                            </div>
                            </div>
